  ...
  <div>
    <el-col :span="row.a">
      <el-form-item :prop="province" :rules="{ required: required, message: '此项不能为空', trigger: 'change' }" label-width="0px"  class="city_slot">
        <el-select :disabled="disabled" v-model.trim="item[province]" placeholder="选择省" style="width: 100%;"
          @change="() => { getCitys(item[province]); item[city] = ''; item[areas] = ''; $emit(`c1`)}" :loading="loading"
          filterable>
    ...
    <el-col :span="row.b" v-if="city">
      <el-form-item :prop="city" :rules="{ required: required, message: '此项不能为空', trigger: 'change' }"  label-width="0px"  class="city_slot">
        <el-select :disabled="disabled" v-model.trim="item[city]" placeholder="选择市"  style="width: 100%;"
    ...
    <el-col :span="row.c" v-if="areas">
      <el-form-item :prop="areas" :rules="{required:areaRequired,message:'此项不能为空',trigger:'change'}"  label-width="0px"  class="city_slot">
        <el-select :disabled="disabled" v-model.trim="item[areas]" placeholder="选择区" @change="areaChange" :loading="loading" clearable  style="width: 100%;">
